...
int zmk_widget_screen_init(struct zmk_widget_screen *widget, lv_obj_t *parent) {
    ...
    lv_obj_align(top, LV_ALIGN_BOTTOM_LEFT, 0 + 5, 0);
    ...
    lv_obj_align(middle, LV_ALIGN_BOTTOM_LEFT, -BUFFER_OFFSET_MIDDLE + 5, 0);
    ...
    // 270度旋转后，为了保持相对位置，需要向右（正方向）偏移相同距离，所以取负号。
    lv_obj_align(bottom, LV_ALIGN_BOTTOM_LEFT, -BUFFER_OFFSET_BOTTOM + 5, 0);
