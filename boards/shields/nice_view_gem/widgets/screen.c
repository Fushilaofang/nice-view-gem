...
int zmk_widget_screen_init(struct zmk_widget_screen *widget, lv_obj_t *parent) {
    ...
    lv_obj_align(top, LV_ALIGN_BOTTOM_LEFT, 0, 0 + 2);
    ...
    lv_obj_align(middle, LV_ALIGN_BOTTOM_LEFT, -BUFFER_OFFSET_MIDDLE, 0 + 2);
    ...
    // 270度旋转后，为了保持相对位置，需要向右（正方向）偏移相同距离，所以取负号。
    lv_obj_align(bottom, LV_ALIGN_BOTTOM_LEFT, -BUFFER_OFFSET_BOTTOM, 0 + 2);
